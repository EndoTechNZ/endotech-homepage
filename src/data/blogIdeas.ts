...
export const blogIdeas: BlogIdea[] = [
  {
    ...
    category: 'Evidence',
    summary: 'How austenite, martensite and heat treatment change flexibility, restoring force and fatigue behaviour.',
    readTime: '4 min read',
    image: '/blog/heat-treatment-niti.webp',
    focus: 'A practical explanation of how metallurgical phase influences file behaviour inside curved anatomy.',
    placeholders: ['Austenite and martensite', 'Curvature and fatigue', 'Clinical trade-offs', 'Micro-Path progression'],
    published: '16 September 2026',
  },
  {
    slug: 'why-file-design-matters',
    title: 'Why file design matters',
    category: 'Technique',
    summary: 'How cross-section, core diameter, flutes, rake angle and heat treatment work together.',
    readTime: '4 min read',
    image: '/blog/why-file-design-matters.webp',
    focus: 'Connecting file geometry and Flex-Ion metallurgy to specific clinical jobs.',
    placeholders: ['Cross-section and core', 'Flutes and rake angle', 'Task-specific design', 'Micro-Path and TransformS'],
    published: '16 September 2026',
  },
  {
    slug: 'choosing-the-right-tip-size-and-taper',
    title: 'Choosing the right tip size and taper',
    category: 'Clinical Thinking',
    summary: 'Why anatomy and the clinical task should determine the final preparation.',
    readTime: '4 min read',
    image: '/blog/choosing-tip-size-and-taper.webp',
    focus: 'A measured approach to glide-path development, enlargement and dentine preservation.',
    placeholders: ['Tip size versus taper', 'Read the anatomy', 'Establish the pathway', 'Shape with restraint'],
    published: '16 September 2026',
  },
  {
