...
const curvedCanalChecklistBaseItems = [
  {
    ...
    number: '01',
    title: 'Assume the canal is more curved than the root looks',
    summary: 'Root form underestimates canal complexity, especially in mesial roots and apical hooks.',
    detail:
  ...
  },
  {
    stage: 'Diagnose and orient',
    number: '02',
    title: 'Read the pre-operative image with the end in mind',
    summary: 'Visualize the final prepared pathway before choosing files, taper, and working strategy.',
    detail:
  ...
  },
  {
    stage: 'Diagnose and orient',
    number: '03',
    title: 'Use angled radiographs or CBCT when needed',
    summary: 'Add information before shaping if the curve disappears, splits, or projects in more than one plane.',
    detail:
  ...
  },
  {
    stage: 'Diagnose and orient',
    number: '04',
    title: 'Refine access before negotiation',
    summary: 'Remove coronal interferences so the file can follow the canal rather than bend around preventable obstruction.',
    detail:
  ...
  {
    stage: 'Prove the glide path',
    number: '05',
    title: 'Flood the chamber and scout with a small file',
    summary: 'Use irrigant and a small pre-curved #08 or #10 K-file to find the path with tactile feedback.',
    detail:
  ...
  },
  {
    stage: 'Prove the glide path',
    number: '06',
    title: 'Pre-curve only the last few flutes',
    summary: 'Place the curve in the terminal 1-2 mm so the tip can read anatomy without over-bending the shaft.',
    detail:
  ...
  },
  {
    stage: 'Prove the glide path',
    number: '07',
    title: 'Confirm slip-slide movement',
    summary: 'A confirmed glide path lets the file return to length passively after being withdrawn slightly.',
    detail:
  ...
  },
  {
    stage: 'Shape lightly',
    number: '08',
    title: 'Let rotary files follow, not discover',
    summary: 'A shaping file should work in an already known pathway instead of negotiating the curve under load.',
    detail:
  ...
  },
  {
    stage: 'Shape lightly',
    number: '09',
    title: 'Use short controlled engagement',
    summary: 'Advance in small movements, withdraw, clean flutes, irrigate, and check that the file still re-enters cleanly.',
    detail:
  ...
  },
  {
    stage: 'Shape lightly',
    number: '10',
    title: 'Recapitulate before debris becomes a block',
    summary: 'Small-file recapitulation protects working length and reduces apical compaction in the curve.',
    detail:
  ...
  },
  {
    stage: 'Shape lightly',
    number: '11',
    title: 'Reduce apical pressure as the radius tightens',
    summary: 'A decreasing radius curve increases cyclic fatigue and transportation risk even after a glide path is present.',
    detail:
  ...
  {
    stage: 'Stop and decide',
    number: '12',
    title: 'Stop when feedback changes',
    summary: 'Resistance, loss of slip-slide, repeated debris blocking, or sudden file pull should trigger reassessment.',
    detail:
  ...
  },
  {
    stage: 'Stop and decide',
    number: '13',
    title: 'Refer before control is lost',
    summary: 'Referral is a clinical control decision when visibility, access, curvature, or tactile feedback becomes unreliable.',
    detail:
