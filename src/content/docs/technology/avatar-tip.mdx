...
import avatarComparison from '../../../assets/avatar-tip-comparison.png';
...
<details class="avatar-toggle">
  <summary class="avatar-toggle__summary">Transform S™ Solution</summary>

  Avatar Tip is the Transform S™ apical geometry designed to improve control where anatomy is least forgiving.
