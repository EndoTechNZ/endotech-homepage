...
<div style={{ overflow: 'hidden', margin: '1.5rem 0', padding: '0.7rem', border: '3px solid #1f2937', borderRadius: '1rem', background: '#fff', boxShadow: '0 10px 28px rgba(15, 23, 42, 0.08)' }}>
  <img
    src={avatarComparison.src}
    alt="Avatar Tip compared with a sharper competitor tip profile"
    style={{ display: 'block', width: '100%', height: 'auto', transform: 'translateY(-18px)', marginBottom: '-18px', borderRadius: '0.45rem' }}
  />
</div>
