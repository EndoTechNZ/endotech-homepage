...
description: A guidance-focused apical tip design engineered for safer progression, canal centering, and control in the apical 2 mm
---
...
<div style="overflow: hidden; margin: 1.5rem 0; padding: 0.8rem; border: 2px solid #111827; border-radius: 1rem; background: #fff; box-shadow: 0 10px 28px rgba(15, 23, 42, 0.08);">
  <img
    ...
    style="display: block; width: 100%; height: auto; margin-top: -24px; margin-bottom: -24px; clip-path: inset(24px 0 24px 0); border: 2px solid #cbd5e1; border-radius: 0.5rem;"
  />
</div>
